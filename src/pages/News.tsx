  ...
  const articles = [
    {
      ...
      excerpt: "Experience the warm, comforting flavors of our new seasonal blend, featuring notes of cinnamon, nutmeg, and caramel.",
    ...
    },
    {
      ...
      excerpt: "We're thrilled to announce that Brewhaus has been named 'Best Coffee Shop' by Bean City Magazine for the third consecutive year.",
    ...
    },
    {
      ...
      excerpt: "Learn about our commitment to sustainability and the steps we're taking to become carbon neutral by 2025.",
    ...
    },
    {
      ...
      excerpt: "Join us for our monthly coffee education workshops where you'll learn about brewing techniques, bean origins, and tasting notes.",
    ...
    },
    {
      ...
      excerpt: "We're excited to announce our new partnership with local coffee farmers, ensuring fresher beans and supporting our community.",
    ...
    },
    {
      ...
      excerpt: "Order ahead, earn rewards, and never wait in line again with our new mobile app, now available for iOS and Android.",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <span className="text-coffee-600 text-sm">{featuredArticle.category}</span>
                  </div>
                  <h2 className="text-3xl font-bold text-coffee-900 mb-4">{featuredArticle.title}</h2>
                  <p className="text-coffee-600 mb-6 text-lg">{featuredArticle.excerpt}</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regularArticles.map((article) => (
              <article key={article.id} className="bg-cream-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
                <div 
      ...
      <section className="py-16 bg-coffee-900 text-cream-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cream-200 mb-8">
            Subscribe to our newsletter for the latest news, special offers, and coffee tips
          </p>
