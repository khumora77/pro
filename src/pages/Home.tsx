...
import { Coffee, Award, Users, Leaf, ArrowRight, Star, Clock, Heart, Shield } from 'lucide-react';
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-coffee-900 to-coffee-800">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080')"
          }}
        ></div>
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 text-cream-100 max-w-2xl mx-auto">
            Experience the perfect blend of exceptional coffee, warm atmosphere, and community connection
          </p>
      ...
      <section className="py-20 bg-cream-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-coffee-900 mb-4">Why Choose Brewhaus?</h2>
            <p className="text-xl text-coffee-600 max-w-2xl mx-auto">
              We're more than just a coffee shop - we're your daily dose of excellence
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-coffee-900 mb-4">Featured Favorites</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-cream-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                <div className="relative">
                  <div className="h-48 bg-cover bg-center group-hover:scale-105 transition-transform duration-300" style={{ backgroundImage: `url(${product.image})` }}></div>
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 flex items-center space-x-1">
                    ...
                    <span className="text-sm font-medium text-coffee-900">{product.rating}</span>
                  </div>
                </div>
                <div className="p-6">
      ...
      <section className="py-20 bg-cream-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-coffee-900 mb-4">Our Services</h2>
            <p className="text-xl text-coffee-600">Everything you need for the perfect coffee experience</p>
          </div>
            ...
            {[
              {
                ...
                description: "Professional coffee service for your events and meetings",
                features: ["Mobile coffee bar", "Professional baristas", "Custom menu options"]
              },
              {
                icon: Clock,
                title: "Express Service",
                description: "Quick service for busy professionals on the go",
                features: ["Mobile ordering", "Curbside pickup", "Express lane"]
              },
              {
                icon: Heart,
                title: "Coffee Subscriptions",
                description: "Fresh coffee delivered to your door monthly",
                features: ["Freshly roasted beans", "Flexible delivery", "Exclusive blends"]
              },
              {
                icon: Shield,
                title: "Quality Guarantee",
                description: "100% satisfaction guaranteed on every cup",
                features: ["Fresh guarantee", "Quality control", "Customer support"]
              }
            ].map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-coffee-900 mb-3">{service.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-coffee-900 mb-4">What Our Customers Say</h2>
            <p className="text-xl text-coffee-600">Real reviews from real coffee lovers</p>
          </div>
            ...
            {[
              {
                ...
                review: "The best coffee in the city! The atmosphere is perfect for working, and the staff always remembers my order.",
                rating: 5,
              ...
              },
              {
                ...
                review: "Brewhaus has ruined all other coffee shops for me. Their single-origin beans are exceptional!",
                rating: 5,
              ...
              },
              {
                ...
                review: "Their catering service made our company event a huge success. Professional and delicious!",
                rating: 5,
              ...
              <div key={index} className="bg-cream-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-coffee-600 mb-6 italic">"{review.review}"</p>
      ...
      <section className="py-20 bg-coffee-900 text-cream-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-cream-200">Numbers that tell our story</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center bg-coffee-800 rounded-xl p-6 hover:bg-coffee-700 transition-colors">
      ...
      <section className="py-20 bg-gradient-to-r from-gold-500 to-gold-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-coffee-900 mb-4">Ready for Your Perfect Cup?</h2>
          <p className="text-xl mb-8 text-coffee-800">
            Visit us today and discover why Brewhaus is the city's favorite coffee destination
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/locations"
