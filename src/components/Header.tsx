        ...
        <div className="absolute top-16 inset-x-0 bg-coffee-800 border-t border-coffee-700 z-40">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold text-cream-50">Our Coffee Menu</h3>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-medium text-gold-400 mb-3">Signature Blends</h4>
              ...
              <div>
                <h4 className="font-medium text-gold-400 mb-3">Specialty Drinks</h4>
                <ul className="space-y-2 text-sm text-cream-100">
              ...
              <div>
                <h4 className="font-medium text-gold-400 mb-3">Seasonal Favorites</h4>
                <ul className="space-y-2 text-sm text-cream-100">
